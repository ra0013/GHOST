#!/usr/bin/env python3
"""
Forensic Intelligence Suite - Complete Working GUI Application
...
try:
    ...
    print("✅ All modules imported successfully for GUI")
...
def main():
    ...
    print("🔍 Starting GHOST Forensic Intelligence Suite GUI...")
